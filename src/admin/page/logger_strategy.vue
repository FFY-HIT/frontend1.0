    ...
    <div>
            ...
            <el-table :data="data" border style="width: 100%" ref="multipleTable">
                ...
                <el-table-column label="检验条件" width="572px">
                    <template slot-scope="scope" width="100px">
                        <el-button v-if="scope.row.stage === '指定节点数量'" type="text" @click="check1()">查看</el-button>
                        <el-button v-if="scope.row.stage === '指定具体节点'" type="text" @click="check2()">查看</el-button>
                    </template>
                </el-table-column>
            </el-table>
        </div>
        ...
        <el-dialog
            ...
            <div style="text-align: center;">
                ...
                <el-button @click="add_mem()">添加</el-button>
                <el-button @click="del_mem()">删除</el-button>
            </div>
        </el-dialog>
        <el-dialog
            width="30%"
            ...
            <div class="form-box">
                <el-form :model="form" :rules="rules" ref="form" label-width="150px">
                    ...
                    <el-form-item style="text-align: center" >
                        ...
                        <el-button @click="addlist_submit()">添加</el-button>
                    </el-form-item>
                </el-form>
            </div>
        </el-dialog>
            ...
            <div class="form-box">
                <el-form :model="form" :rules="rules" ref="form" label-width="150px">
                    ...
                    <el-form-item style="text-align: center" >
                        ...
                        <el-button @click="dellist_submit()">删除</el-button>
                    </el-form-item>
                </el-form>
            </div>
        </el-dialog>
